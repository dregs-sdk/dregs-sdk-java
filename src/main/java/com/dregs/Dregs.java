...
import com.dregs.model.TrackResult;
...
public final class Dregs extends AbstractDregsClient implements AutoCloseable {
     ...
     * @throws com.dregs.exception.QuotaExceededException when the account is over its monthly
     *     event limit
     * @throws com.dregs.exception.RateLimitException when the credential is ingesting too fast
     * @throws com.dregs.exception.AuthenticationException when the secret key was not recognized
     * @throws com.dregs.exception.BadRequestException when the event was malformed
     */
